...
with open("input.txt") as file:
    ...
    while True:
                ...
                if (i, j) in hp and not hp[(i, j)][2]:
                    ...
                    def attack(i, j):
                        ...
                        if opposite_char is not None:
                            if hp[(opposite_char[0], opposite_char[1])][1] - 3 < 1:
                                cave[opposite_char[0]][opposite_char[1]] = "."
                                del hp[(opposite_char[0], opposite_char[1])]
                                
                            else:
                                hp[(opposite_char[0], opposite_char[1])][1] -= 3
                            return True
                        return False
        ...
        if g_count == 0 or e_count == 0:
            print(sum([i[1] for i in hp.values()]) * (game_count-1))
            break
        else:
            game_count += 1
        print("G: ", g_count, " E: ", e_count)
        # print(sorted([(k, v[1]) for k,v in hp.items()]))
